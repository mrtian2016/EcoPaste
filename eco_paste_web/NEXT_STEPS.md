...
```bash
cd /Users/tianjy/projects/EcoPaste/eco_paste_web
pnpm install
pnpm dev
```
...
# 复制通用组件
cp -r src/components/ProSelect eco_paste_web/src/components/
cp -r src/components/ProSwitch eco_paste_web/src/components/
cp -r src/components/UnoIcon eco_paste_web/src/components/
cp -r src/components/Scrollbar eco_paste_web/src/components/

# 复制工具函数
cp -r src/utils/dayjs.ts eco_paste_web/src/utils/
cp -r src/utils/color.ts eco_paste_web/src/utils/
cp -r src/utils/dom.ts eco_paste_web/src/utils/
```
